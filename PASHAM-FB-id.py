...
# LO KONTOL
logo = ''' \033[0;96m ____ ___ _____ __ _____ __ ___
 \033[0;96m / __ \/ | / ___// / / / | / |/ / \033[0m|| Created By PASHAM
 \033[0;96m  / /_/ / /| | \__ \/ /_/ / /| | / /|_/ /  \033[0m|| Github.com/pasha_hawleri
 \033[0;96m / ____/ ___ |___/ / __ / ___ |/ / / /  \033[0;91mv2.0  \033[0m|| PASHA'M'''
 \033[0;96m /_/ /_/ |_/____/_/ /_/_/ |_/_/ /_/   \033[0m||
...
def yayanxd():
    ...
    try:
        ...
        os.system('xdg-open https://t.me/pasha_hawleri5335')
        moch_yayan()
    except KeyError:
...
def moch_yayan():
    ...
    IP = ipm["origin"]
    print '______________________________________________________PASHAM"\n';time.sleep(0.03)
